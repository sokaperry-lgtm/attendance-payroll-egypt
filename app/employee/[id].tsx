...
const styles=StyleSheet.create({content:{padding:22,paddingBottom:60,maxWidth:1180,width:"100%",alignSelf:"center",gap:14},backLink:{color:"#5B9BFF",fontSize:12,fontWeight:"800",textAlign:"right"},hero:{backgroundColor:"#0B1220",borderRadius:26,padding:24,flexDirection:"row-reverse",alignItems:"center",gap:16},avatar:{width:76,height:76,borderRadius:24,backgroundColor:"#3B82F6",alignItems:"center",justifyContent:"center"},avatarText:{color:"#F5F7FA",fontSize:24,fontWeight:"900"},kicker:{color:"#93C5FD",fontSize:9,fontWeight:"900",textAlign:"right"},name:{color:"#F5F7FA",fontSize:27,fontWeight:"900",textAlign:"right",marginTop:4},role:{color:"#8592A6",fontSize:12,textAlign:"right",marginTop:4},status:{flexDirection:"row-reverse",alignItems:"center",gap:6,marginTop:10},dot:{width:8,height:8,borderRadius:4,backgroundColor:"#34D399"},statusText:{color:"#8B96A8",fontSize:10},grid:{flexDirection:"row-reverse",gap:14},card:{flex:1,backgroundColor:"#131A24",borderWidth:1,borderColor:"#232C3A",borderRadius:20,padding:18},cardTitle:{color:"#EEF2F8",fontSize:15,fontWeight:"900",textAlign:"right",marginBottom:8},row:{flexDirection:"row-reverse",justifyContent:"space-between",paddingVertical:11,borderBottomWidth:1,borderBottomColor:"#1A212C"},label:{color:"#97A3B6",fontSize:11},value:{color:"#EEF2F8",fontSize:12,fontWeight:"800"},payroll:{backgroundColor:"#15243D",borderRadius:14,padding:16,alignItems:"flex-end"},payrollValue:{color:"#93C5FD",fontSize:23,fontWeight:"900"},payrollLabel:{color:"#97A3B6",fontSize:10,marginTop:3},metrics:{flexDirection:"row-reverse",gap:8,marginTop:10},metric:{flex:1,backgroundColor:"#10161F",borderRadius:12,padding:10,alignItems:"center"},metricValue:{color:"#EEF2F8",fontSize:16,fontWeight:"900"},metricLabel:{color:"#97A3B6",fontSize:8,marginTop:2},hint:{color:"#97A3B6",fontSize:11,lineHeight:20,textAlign:"right"},state:{flex:1,alignItems:"center",justifyContent:"center",gap:12},stateTitle:{fontSize:20,fontWeight:"900",color:"#EEF2F8"},back:{backgroundColor:"#3B82F6",paddingHorizontal:20,paddingVertical:12,borderRadius:12},backText:{color:"#F5F7FA",fontWeight:"800"}});