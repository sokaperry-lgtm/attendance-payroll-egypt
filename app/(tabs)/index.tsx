...
const styles = StyleSheet.create({
  ...
  barTrack: { width: 20, height: 135, justifyContent: "flex-end", backgroundColor: "#F8FAFC", borderRadius: 8, overflow: "hidden" },
  bar: { width: "100%", backgroundColor: "#3B82F6", borderRadius: 8 },
  barValue: { color: "#64748B", fontSize: 8, marginTop: 5 },
  barLabel: { color: "#94A3B8", fontSize: 9, marginTop: 3 },
