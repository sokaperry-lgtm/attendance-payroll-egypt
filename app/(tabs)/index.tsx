...
const styles = StyleSheet.create({
  ...
  gridLine: { position: "absolute", left: 0, right: 0, top: 0, height: 1, backgroundColor: "#F1F5F9" },
  ...
  barTrack: { width: 22, height: 140, backgroundColor: "#F1F5F9", borderRadius: 8, justifyContent: "flex-end", overflow: "hidden" },
  bar: { width: "100%", minHeight: 4, backgroundColor: "#2563EB", borderRadius: 8 },
  barValue: { color: "#0F172A", fontSize: 10, fontWeight: "800" },
