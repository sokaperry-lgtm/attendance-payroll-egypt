...
const styles = StyleSheet.create({
  ...
  notificationButton: { width: 46, height: 46, borderRadius: 15, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7E2D9", alignItems: "center", justifyContent: "center", position: "relative" },
  ...
  eyebrow: { color: "#7B817E", fontSize: 12, marginBottom: 5, textAlign: "right" },
  title: { color: "#303735", fontSize: 27, fontWeight: "800", textAlign: "right" },
  subtitle: { color: "#7B817E", fontSize: 13, marginTop: 5, textAlign: "right" },
  avatar: { width: 50, height: 50, borderRadius: 17, backgroundColor: "#668C7F", alignItems: "center", justifyContent: "center", marginLeft: 14 },
  avatarText: { color: "#FFFFFF", fontWeight: "800", fontSize: 16 },
  hero: { backgroundColor: "#FFFFFF", borderRadius: 28, padding: 24, overflow: "hidden", shadowColor: "#303735", shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 5 },
  heroGlow: { position: "absolute", width: 210, height: 210, borderRadius: 105, backgroundColor: "#668C7F", opacity: 0.35, top: -100, left: -50 },
  ...
  heroCopy: { flex: 1 },
  heroEyebrow: { color: "#668C7F", fontSize: 11, textAlign: "right" },
  heroTitle: { color: "#FFFFFF", fontSize: 25, fontWeight: "800", marginTop: 2, textAlign: "right" },
  heroMeta: { color: "#7B817E", fontSize: 12, marginTop: 4, textAlign: "right" },
  ...
  progressTrack: { flex: 1, height: 7, backgroundColor: "#E7E2D9", borderRadius: 10, overflow: "hidden" },
  progressFill: { height: "100%", backgroundColor: "#55786D", borderRadius: 10 },
  sectionHeading: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", marginTop: 3 },
  sectionTitle: { color: "#303735", fontSize: 18, fontWeight: "800", textAlign: "right" },
  ...
  kpiCard: { flex: 1, backgroundColor: "#FFFFFF", borderRadius: 20, padding: 17, minHeight: 140, borderWidth: 1, borderColor: "#E7E2D9", shadowColor: "#303735", shadowOpacity: 0.03, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1 },
  kpiIcon: { width: 34, height: 34, borderRadius: 11, alignItems: "center", justifyContent: "center", marginBottom: 10 },
  kpiValue: { color: "#303735", fontSize: 21, fontWeight: "800", textAlign: "right" },
  kpiLabel: { color: "#7B817E", fontSize: 11, marginTop: 3, textAlign: "right" },
  ...
  chartCard: { flex: 1.65, minWidth: 330, backgroundColor: "#FFFFFF", borderRadius: 20, padding: 17, borderWidth: 1, borderColor: "#E7E2D9" },
  statusCard: { flex: 1, minWidth: 270, backgroundColor: "#FFFFFF", borderRadius: 20, padding: 17, borderWidth: 1, borderColor: "#E7E2D9" },
  cardHeader: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" },
  cardTitle: { color: "#303735", fontSize: 14, fontWeight: "800", textAlign: "right" },
  ...
  legendDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: "#55786D" },
  ...
  bar: { width: "100%", minHeight: 4, backgroundColor: "#55786D", borderRadius: 8 },
  barValue: { color: "#303735", fontSize: 10, fontWeight: "800" },
  ...
  donutValue: { color: "#303735", fontSize: 21, fontWeight: "800" },
  ...
  statusPercent: { color: "#303735", fontSize: 10, fontWeight: "800" },
  attendanceCard: { backgroundColor: "#FFFFFF", borderRadius: 20, padding: 18, borderWidth: 1, borderColor: "#E7E2D9" },
  ...
  primaryButton: { minHeight: 52, borderRadius: 15, backgroundColor: "#55786D", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 9, marginTop: 15 },
  ...
  quickCard: { flex: 1, minWidth: 180, backgroundColor: "#FFFFFF", borderRadius: 19, borderWidth: 1, borderColor: "#E7E2D9", padding: 16, flexDirection: "row-reverse", alignItems: "center", gap: 12, shadowColor: "#303735", shadowOpacity: 0.04, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1 },
  quickIcon: { width: 46, height: 46, borderRadius: 14, backgroundColor: "#E7EEEB", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#D6E2DC" },
  quickLabel: { color: "#66706B", fontSize: 13, fontWeight: "800", flex: 1, textAlign: "right" },
  quickArrow: { color: "#8A918D", fontSize: 16 },
  insight: { backgroundColor: "#EEF3EF", borderRadius: 17, padding: 14, borderWidth: 1, borderColor: "#718A7F", flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  insightIcon: { width: 37, height: 37, borderRadius: 12, backgroundColor: "#EEF3EF", alignItems: "center", justifyContent: "center" },
  insightCopy: { flex: 1 },
  insightTitle: { color: "#718A7F", fontSize: 11, fontWeight: "800", textAlign: "right" },
  insightText: { color: "#718A7F", fontSize: 10, lineHeight: 17, marginTop: 2, textAlign: "right" },
  ...
  notice: { backgroundColor: "#FBF4E9", borderRadius: 14, padding: 13, flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  noticeText: { color: "#B18452", fontSize: 11, flex: 1, lineHeight: 17, textAlign: "right" },
  installCard: { backgroundColor: "#E7EEEB", borderRadius: 14, padding: 13, flexDirection: "row-reverse", alignItems: "center", gap: 9, borderWidth: 1, borderColor: "#D6E2DC" },
  installCopy: { flex: 1 },
  installTitle: { color: "#668C7F", fontSize: 11, fontWeight: "800", textAlign: "right" },
  installText: { color: "#668C7F", fontSize: 10, lineHeight: 16, marginTop: 3, textAlign: "right" },
});
