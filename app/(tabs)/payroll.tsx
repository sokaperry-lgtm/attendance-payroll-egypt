    ...
    <ScreenContainer>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.monthBar}>
          <Pressable onPress={() => setMonth(shiftMonth(month, -1))} style={styles.monthButton}><Text style={styles.monthButtonLabel}>الشهر السابق</Text></Pressable>
          <View style={styles.monthCenter}><Text style={styles.monthKicker}>PAYROLL PERIOD</Text><Text style={styles.monthTitle}>{monthLabel(month)}</Text><Text style={styles.monthHint}>اضغط الأسهم للتنقل بين الشهور</Text></View>
          <Pressable onPress={() => setMonth(shiftMonth(month, 1))} style={styles.monthButton}><Text style={styles.monthButtonLabel}>الشهر التالي</Text></Pressable>
        </View>
        ...
        <View style={styles.table}>
          {filteredRows.length === 0 ? (
            ...
            return (
              <Pressable key={r.id} onPress={() => setSelectedRowId(r.id)} style={[styles.employeeRow, selectedRowId === r.id && styles.employeeRowSelected]}>
...
const styles = StyleSheet.create({
  ...
  monthBar:{backgroundColor:"#FFFFFF",borderWidth:1,borderColor:"#E5EAF0",borderRadius:17,padding:10,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},monthCenter:{alignItems:"center"},monthKicker:{color:"#98A6B8",fontSize:8,fontWeight:"900"},monthTitle:{color:"#172033",fontSize:14,fontWeight:"900",marginTop:2},monthButton:{width:38,height:38,borderRadius:11,backgroundColor:"#EEF4FB",alignItems:"center",justifyContent:"center"},monthButtonLabel:{color:"#163A63",fontSize:9,fontWeight:"900",textAlign:"center"},monthHint:{color:"#A1ACBA",fontSize:8,marginTop:3},
