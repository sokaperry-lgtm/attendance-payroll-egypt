    ...
    <ScreenContainer>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.reviewLane, compact && styles.reviewLaneCompact]}>
          ...
          <ReviewItem label="سلف نشطة" value={String((advances.data ?? []).filter(a => a.status === "active").length)} />
          <ReviewItem label="موظفو المسير" value={String(salaryRows.length)} />
        </View><View style={[styles.actionCard, compact && styles.actionCardCompact]}>
          ...
          <Pressable
            ...
            onPress={async () => {
              // Payroll generation must use the salary stored on each employee record.
              // Never mutate a salary implicitly from the payroll screen.
...
function ReviewItem({ label, value }: { label: string; value: string }) {
  return <View style={styles.reviewItem}><Text style={styles.reviewValue}>{value}</Text><Text style={styles.reviewLabel}>{label}</Text></View>;
}
...
const styles = StyleSheet.create({
  ...
  reviewLane:{flexDirection:"row-reverse",gap:8},reviewLaneCompact:{flexDirection:"column"},reviewItem:{flex:1,backgroundColor:"#F8FAFC",borderWidth:1,borderColor:"#E5EAF0",borderRadius:14,padding:12,minHeight:62,justifyContent:"center"},reviewValue:{color:"#163A63",fontSize:15,fontWeight:"900",textAlign:"right"},reviewLabel:{color:"#667085",fontSize:8,fontWeight:"700",textAlign:"right",marginTop:3},
  ...
  approvalCard:{backgroundColor:"#FFFFFF",borderWidth:1,borderColor:"#E5EAF0",borderRadius:18,padding:15},approvalTop:{flexDirection:"row-reverse",alignItems:"center",justifyContent:"space-between"},approvalTitle:{color:"#172033",fontSize:12,fontWeight:"900",textAlign:"right"},approvalText:{color:"#98A6B8",fontSize:9,textAlign:"right",marginTop:4},approvalPercent:{color:"#163A63",fontSize:24,fontWeight:"900"},progressTrack:{height:8,borderRadius:8,backgroundColor:"#EAF0F5",marginTop:12,overflow:"hidden"},progressFill:{height:8,borderRadius:8,backgroundColor:"#1677D2"},insightGrid:{flexDirection:"row-reverse",gap:10},insight:{flex:1,backgroundColor:"#FFFFFF",borderWidth:1,borderColor:"#E5EAF0",borderRadius:16,padding:14},insightValue:{color:"#163A63",fontSize:16,fontWeight:"900",textAlign:"right"},insightTitle:{color:"#172033",fontSize:10,fontWeight:"900",textAlign:"right",marginTop:7},insightMeta:{color:"#98A6B8",fontSize:8,textAlign:"right",marginTop:3},
  ...
  printButton:{backgroundColor:"#163A63",borderRadius:12,paddingHorizontal:16,paddingVertical:12,flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7},printButtonDisabled:{opacity:0.55},printText:{color:"#FFFFFF",fontSize:10,fontWeight:"900"},
