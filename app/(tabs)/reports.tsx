...
const toneMap: Record<Tone, { bg: string; color: string }> = {
  blue: { bg: "#15243D", color: "#5B9BFF" },
  green: { bg: "#0F2A20", color: "#34D399" },
  orange: { bg: "#2B2010", color: "#FB923C" },
  red: { bg: "#2B1618", color: "#F87171" },
        ...
        <View style={styles.toolbar}>
          ...
          <View style={styles.toolbarActions}>
            ...
            <Pressable onPress={handleExport} disabled={exporting} style={({ pressed }) => [styles.exportButton, exporting && styles.disabled, pressed && styles.pressed]}>
              <IconSymbol name="arrow.down.doc.fill" size={17} color="#F5F7FA" />
...
const styles = StyleSheet.create({
  ...
  toolbar: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", backgroundColor: "#15243D", borderRadius: 16, padding: 13, borderWidth: 1, borderColor: "#243352" }, toolbarActions: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  ...
  filterButton: { backgroundColor: "#131A24", borderWidth: 1, borderColor: "#243352", borderRadius: 11, paddingVertical: 9, paddingHorizontal: 11, flexDirection: "row-reverse", alignItems: "center", gap: 6, maxWidth: 170 }, filterText: { color: UI.primary, fontSize: 10, fontWeight: "900" }, exportButton: { backgroundColor: UI.primary, borderRadius: 11, paddingVertical: 10, paddingHorizontal: 14, flexDirection: "row-reverse", alignItems: "center", gap: 7 }, exportText: { color: "#F5F7FA", fontSize: 11, fontWeight: "900" }, disabled: { backgroundColor: "#2A3346" }, pressed: { opacity: 0.82 },
  ...
  barChart: { height: 220, flexDirection: "row-reverse", alignItems: "flex-end", justifyContent: "space-around", gap: 8, paddingTop: 22 }, barColumn: { flex: 1, height: "100%", alignItems: "center", justifyContent: "flex-end", gap: 6 }, barValue: { color: UI.ink, fontSize: 9, fontWeight: "800" }, barTrack: { height: 145, width: 24, backgroundColor: "#1A212C", borderRadius: 9, justifyContent: "flex-end", overflow: "hidden" }, barFill: { width: "100%", backgroundColor: UI.primary, borderRadius: 9 }, barLabel: { color: UI.muted, fontSize: 9 }, empty: { color: "#8592A6", fontSize: 11, textAlign: "center", padding: 20 },
  distributionBar: { height: 18, flexDirection: "row-reverse", borderRadius: 9, overflow: "hidden", backgroundColor: "#1A212C", marginVertical: 17 }, distributionSegment: { height: "100%" }, distributionNote: { color: UI.muted, fontSize: 9, textAlign: "center", marginBottom: 14 }, legend: { gap: 8 }, legendRow: { flexDirection: "row-reverse", alignItems: "center", gap: 6 }, legendDot: { width: 8, height: 8, borderRadius: 4 }, legendLabel: { color: UI.muted, fontSize: 10, flex: 1, textAlign: "right" }, legendValue: { color: UI.ink, fontSize: 10, fontWeight: "800", width: 26, textAlign: "right" }, legendTrack: { flex: 1, height: 5, backgroundColor: "#1A212C", borderRadius: 9, overflow: "hidden" }, legendFill: { height: "100%", borderRadius: 9 },
  payrollGrid: { flexDirection: "row-reverse", gap: 10, flexWrap: "wrap" }, metricCard: { flex: 1, minWidth: 190, backgroundColor: "#131A24", borderWidth: 1, borderColor: UI.border, borderTopWidth: 4, borderRadius: 16, padding: 15 }, metricLabel: { color: UI.muted, fontSize: 10, textAlign: "right" }, metricValue: { fontSize: 17, fontWeight: "900", marginTop: 9, textAlign: "right" },
  departmentList: { gap: 14, marginTop: 12 }, departmentRow: { gap: 6 }, departmentTop: { flexDirection: "row-reverse", justifyContent: "space-between" }, departmentName: { color: UI.ink, fontSize: 11, fontWeight: "800" }, departmentRate: { color: UI.primary, fontSize: 11, fontWeight: "900" }, departmentTrack: { height: 8, backgroundColor: "#15243D", borderRadius: 9, overflow: "hidden" }, departmentFill: { height: "100%", backgroundColor: UI.primary, borderRadius: 9 },
  lateList: { gap: 9, marginTop: 10 }, lateRow: { flexDirection: "row-reverse", alignItems: "center", gap: 9, borderBottomWidth: 1, borderBottomColor: "#1A212C", paddingBottom: 9 }, lateBadge: { width: 46, height: 42, borderRadius: 12, backgroundColor: "#2B2010", alignItems: "center", justifyContent: "center" }, lateBadgeValue: { color: "#FB923C", fontSize: 14, fontWeight: "900" }, lateBadgeLabel: { color: "#FB923C", fontSize: 8 }, lateCopy: { flex: 1 }, lateName: { color: UI.ink, fontSize: 11, fontWeight: "800", textAlign: "right" }, lateMeta: { color: UI.muted, fontSize: 9, marginTop: 3, textAlign: "right" },
  modalBackdrop: { flex: 1, backgroundColor: "rgba(15,23,42,0.42)", justifyContent: "flex-end" }, filterSheet: { backgroundColor: "#131A24", borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 18, maxHeight: "82%", width: "100%" }, sheetHeader: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 13 }, sheetTitle: { color: UI.ink, fontSize: 18, fontWeight: "900", textAlign: "right" }, sheetSubtitle: { color: UI.muted, fontSize: 10, marginTop: 4, textAlign: "right" }, closeText: { color: UI.primary, fontSize: 11, fontWeight: "800", padding: 5 }, employeeOptions: { maxHeight: 390 }, employeeOptionsContent: { gap: 8, paddingBottom: 8 }, employeeOption: { flexDirection: "row-reverse", alignItems: "center", gap: 10, borderWidth: 1, borderColor: UI.border, borderRadius: 15, padding: 11 }, employeeOptionActive: { borderColor: "#93C5FD", backgroundColor: "#15243D" }, optionAvatar: { width: 38, height: 38, borderRadius: 12, backgroundColor: "#1B2A45", alignItems: "center", justifyContent: "center" }, optionAvatarText: { color: UI.primary, fontSize: 11, fontWeight: "900" }, optionCopy: { flex: 1 }, optionName: { color: UI.ink, fontSize: 12, fontWeight: "900", textAlign: "right" }, optionMeta: { color: UI.muted, fontSize: 9, marginTop: 3, textAlign: "right" }, selectedMark: { color: UI.primary, fontSize: 18, fontWeight: "900" },
});
