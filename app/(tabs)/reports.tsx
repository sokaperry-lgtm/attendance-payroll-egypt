...
const styles = StyleSheet.create({
  ...
  toolbar: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", backgroundColor: "#FFFFFF", borderRadius: 16, padding: 13, borderWidth: 1, borderColor: "#243352" }, toolbarActions: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
