      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.chartRow}>
          ...
          <SurfaceCard style={styles.chartCardSmall}>
            ...
            <View style={styles.donut}><View style={styles.donutInner}><Text style={styles.donutValue}>{attendanceRate}%</Text><Text style={styles.donutLabel}>حضور</Text></View></View>
...
const styles = StyleSheet.create({
  ...
  donut: { alignSelf: "center", width: 128, height: 128, borderRadius: 64, borderWidth: 14, borderColor: "#10B981", borderLeftColor: "#F59E0B", alignItems: "center", justifyContent: "center", marginVertical: 12 }, donutInner: { width: 82, height: 82, borderRadius: 41, backgroundColor: "#FFF", alignItems: "center", justifyContent: "center" }, donutValue: { color: UI.ink, fontSize: 21, fontWeight: "900" }, donutLabel: { color: UI.muted, fontSize: 9, marginTop: 2 }, legend: { gap: 8 }, legendRow: { flexDirection: "row-reverse", alignItems: "center", gap: 6 }, legendDot: { width: 8, height: 8, borderRadius: 4 }, legendLabel: { color: UI.muted, fontSize: 10, width: 42, textAlign: "right" }, legendValue: { color: UI.ink, fontSize: 10, fontWeight: "800", width: 26, textAlign: "right" }, legendTrack: { flex: 1, height: 5, backgroundColor: "#F1F5F9", borderRadius: 9, overflow: "hidden" }, legendFill: { height: "100%", borderRadius: 9 },
