...
export default function HrToolsScreen(){
 ...
 if(role!=="owner" && role!=="manager") return <ScreenContainer><View style={styles.denied}><IconSymbol name="lock" size={34} color="#163A63"/><Text style={styles.deniedTitle}>إدارة الرواتب للمدير فقط</Text></View></ScreenContainer>;
