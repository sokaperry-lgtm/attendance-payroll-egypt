...
const styles = StyleSheet.create({
  detailModal:{backgroundColor:"#FFFFFF",borderTopLeftRadius:26,borderTopRightRadius:26,padding:20,gap:10},detailHead:{flexDirection:"row-reverse",justifyContent:"space-between",alignItems:"center"},detailTitle:{color:"#303735",fontSize:20,fontWeight:"900"},closeText:{color:"#668C7F",fontSize:11},detailType:{color:"#668C7F",fontSize:18,fontWeight:"800",textAlign:"right"},detailDates:{color:"#7B817E",fontSize:12,textAlign:"right"},detailStatus:{alignSelf:"flex-end",backgroundColor:"#2B2410",borderRadius:99,paddingHorizontal:12,paddingVertical:6},detailStatusText:{color:"#B77A32",fontSize:10,fontWeight:"800"},detailLabel:{color:"#7B817E",fontSize:10,fontWeight:"700",textAlign:"right",marginTop:10},detailReason:{color:"#303735",fontSize:13,lineHeight:20,textAlign:"right"},timeline:{backgroundColor:"#10161F",borderRadius:14,padding:13,marginTop:8},timelineTitle:{color:"#303735",fontSize:12,fontWeight:"800",textAlign:"right"},timelineText:{color:"#7B817E",fontSize:11,lineHeight:18,textAlign:"right",marginTop:4},
  ...
  requestsHeroText: { color: "#8A918D", fontSize: 10, marginTop: 3, textAlign: "right" },
  requestsHeroBadge: { alignItems: "center" },
  requestsHeroNumber: { color: "#C4B5FD", fontSize: 24, fontWeight: "900" },
  requestsHeroLabel: { color: "#8A918D", fontSize: 9 },
  content: { padding: 20, paddingBottom: 40, gap: 17 }, header: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, eyebrow: { color: "#7B817E", fontSize: 13, textAlign: "right" }, title: { color: "#303735", fontSize: 27, fontWeight: "800", marginTop: 5, textAlign: "right" }, subtitle: { color: "#7B817E", fontSize: 12, marginTop: 5, textAlign: "right" }, addButton: { backgroundColor: "#668C7F", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 11 }, addButtonText: { color: "#FFFFFF", fontSize: 12, fontWeight: "800" }, info: { backgroundColor: "#E7EEEB", borderRadius: 18, padding: 17, borderWidth: 1, borderColor: "#D6E2DC" }, infoRow: { flexDirection: "row-reverse", gap: 10 }, infoHalf: { flex: 1 }, infoSick: { backgroundColor: "#F7E7E7", borderColor: "#3A2226" }, infoTitleSick: { color: "#FCA5A5" }, infoValueSick: { color: "#B85C5C" }, infoUnitSick: { color: "#FCA5A5" }, infoHintSick: { color: "#B85C5C" }, infoTitle: { color: "#93C5FD", fontSize: 13, textAlign: "right" }, infoValue: { color: "#668C7F", fontSize: 30, fontWeight: "800", textAlign: "right", marginTop: 4 }, infoUnit: { color: "#93C5FD", fontSize: 12, fontWeight: "500" }, infoHint: { color: "#668C7F", fontSize: 11, marginTop: 4, textAlign: "right" }, sectionTitle: { color: "#303735", fontSize: 18, fontWeight: "800", textAlign: "right" }, requestCard: { backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7E2D9", borderRadius: 18, padding: 15 }, requestTop: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, requestType: { color: "#303735", fontSize: 15, fontWeight: "800" }, statusBadge: { borderRadius: 9, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { fontSize: 10, fontWeight: "800" }, requestDates: { color: "#8A918D", fontSize: 12, marginTop: 12, textAlign: "right" }, reason: { color: "#7B817E", fontSize: 12, marginTop: 6, lineHeight: 19, textAlign: "right" }, empty: { color: "#7B817E", textAlign: "center", padding: 25 }, modalBackdrop: { flex: 1, backgroundColor: "rgba(15,23,42,0.45)", justifyContent: "flex-end" }, modal: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 26, borderTopRightRadius: 26, padding: 20, paddingBottom: 35 }, modalHeader: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }, close: { color: "#7B817E", fontSize: 13 }, modalTitle: { color: "#303735", fontSize: 20, fontWeight: "800" }, fieldLabel: { color: "#AAB4C4", fontSize: 12, fontWeight: "700", marginTop: 10, marginBottom: 6, textAlign: "right" }, typeRow: { flexDirection: "row-reverse", gap: 8 }, typeChip: { borderWidth: 1, borderColor: "#8B96A8", borderRadius: 12, paddingHorizontal: 13, paddingVertical: 9 }, typeChipActive: { backgroundColor: "#E8EEE9", borderColor: "#668C7F" }, typeChipText: { color: "#7B817E", fontSize: 12 }, typeChipTextActive: { color: "#668C7F", fontWeight: "800" }, input: { borderWidth: 1, borderColor: "#8B96A8", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, color: "#303735", textAlign: "right", fontSize: 13 }, textArea: { height: 68, textAlignVertical: "top" }, submitButton: { backgroundColor: "#668C7F", borderRadius: 14, paddingVertical: 14, alignItems: "center", marginTop: 18 }, submitText: { color: "#FFFFFF", fontWeight: "800" },
});
