...
const requestPalette: Record<string, { bg: string; text: string }> = { "قيد المراجعة": { bg: "#2B2410", text: "#FBBF24" }, مقبول: { bg: "#122A1E", text: "#4ADE80" }, مرفوض: { bg: "#2B1618", text: "#FCA5A5" } };
...
export default function RequestsScreen() {
  ...
  return <ScreenContainer><ScrollView contentContainerStyle={styles.content}>
    ...
    <View style={styles.requestsHero}>
      <View style={styles.requestsHeroIcon}><IconSymbol name="doc.text" size={22} color="#F5F7FA" /></View>
...
const styles = StyleSheet.create({
  detailModal:{backgroundColor:"#131A24",borderTopLeftRadius:26,borderTopRightRadius:26,padding:20,gap:10},detailHead:{flexDirection:"row-reverse",justifyContent:"space-between",alignItems:"center"},detailTitle:{color:"#EEF2F8",fontSize:20,fontWeight:"900"},closeText:{color:"#5B9BFF",fontSize:11},detailType:{color:"#5B9BFF",fontSize:18,fontWeight:"800",textAlign:"right"},detailDates:{color:"#97A3B6",fontSize:12,textAlign:"right"},detailStatus:{alignSelf:"flex-end",backgroundColor:"#2B2410",borderRadius:99,paddingHorizontal:12,paddingVertical:6},detailStatusText:{color:"#FBBF24",fontSize:10,fontWeight:"800"},detailLabel:{color:"#97A3B6",fontSize:10,fontWeight:"700",textAlign:"right",marginTop:10},detailReason:{color:"#EEF2F8",fontSize:13,lineHeight:20,textAlign:"right"},timeline:{backgroundColor:"#10161F",borderRadius:14,padding:13,marginTop:8},timelineTitle:{color:"#EEF2F8",fontSize:12,fontWeight:"800",textAlign:"right"},timelineText:{color:"#97A3B6",fontSize:11,lineHeight:18,textAlign:"right",marginTop:4},
  requestsHero: { backgroundColor: "#0B1220", borderRadius: 23, padding: 18, flexDirection: "row-reverse", alignItems: "center", gap: 12 },
  requestsHeroIcon: { width: 45, height: 45, borderRadius: 14, backgroundColor: "#5B21B6", alignItems: "center", justifyContent: "center" },
  requestsHeroCopy: { flex: 1 },
  requestsHeroTitle: { color: "#F5F7FA", fontSize: 16, fontWeight: "800", textAlign: "right" },
  requestsHeroText: { color: "#8592A6", fontSize: 10, marginTop: 3, textAlign: "right" },
  requestsHeroBadge: { alignItems: "center" },
  requestsHeroNumber: { color: "#C4B5FD", fontSize: 24, fontWeight: "900" },
  requestsHeroLabel: { color: "#8592A6", fontSize: 9 },
  content: { padding: 20, paddingBottom: 40, gap: 17 }, header: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, eyebrow: { color: "#97A3B6", fontSize: 13, textAlign: "right" }, title: { color: "#EEF2F8", fontSize: 27, fontWeight: "800", marginTop: 5, textAlign: "right" }, subtitle: { color: "#97A3B6", fontSize: 12, marginTop: 5, textAlign: "right" }, addButton: { backgroundColor: "#3B82F6", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 11 }, addButtonText: { color: "#F5F7FA", fontSize: 12, fontWeight: "800" }, info: { backgroundColor: "#15243D", borderRadius: 18, padding: 17, borderWidth: 1, borderColor: "#243352" }, infoRow: { flexDirection: "row-reverse", gap: 10 }, infoHalf: { flex: 1 }, infoSick: { backgroundColor: "#2B1618", borderColor: "#3A2226" }, infoTitleSick: { color: "#FCA5A5" }, infoValueSick: { color: "#F87171" }, infoUnitSick: { color: "#FCA5A5" }, infoHintSick: { color: "#F87171" }, infoTitle: { color: "#93C5FD", fontSize: 13, textAlign: "right" }, infoValue: { color: "#5B9BFF", fontSize: 30, fontWeight: "800", textAlign: "right", marginTop: 4 }, infoUnit: { color: "#93C5FD", fontSize: 12, fontWeight: "500" }, infoHint: { color: "#5B9BFF", fontSize: 11, marginTop: 4, textAlign: "right" }, sectionTitle: { color: "#EEF2F8", fontSize: 18, fontWeight: "800", textAlign: "right" }, requestCard: { backgroundColor: "#131A24", borderWidth: 1, borderColor: "#232C3A", borderRadius: 18, padding: 15 }, requestTop: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, requestType: { color: "#EEF2F8", fontSize: 15, fontWeight: "800" }, statusBadge: { borderRadius: 9, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { fontSize: 10, fontWeight: "800" }, requestDates: { color: "#8592A6", fontSize: 12, marginTop: 12, textAlign: "right" }, reason: { color: "#97A3B6", fontSize: 12, marginTop: 6, lineHeight: 19, textAlign: "right" }, empty: { color: "#97A3B6", textAlign: "center", padding: 25 }, modalBackdrop: { flex: 1, backgroundColor: "rgba(15,23,42,0.45)", justifyContent: "flex-end" }, modal: { backgroundColor: "#131A24", borderTopLeftRadius: 26, borderTopRightRadius: 26, padding: 20, paddingBottom: 35 }, modalHeader: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }, close: { color: "#97A3B6", fontSize: 13 }, modalTitle: { color: "#EEF2F8", fontSize: 20, fontWeight: "800" }, fieldLabel: { color: "#AAB4C4", fontSize: 12, fontWeight: "700", marginTop: 10, marginBottom: 6, textAlign: "right" }, typeRow: { flexDirection: "row-reverse", gap: 8 }, typeChip: { borderWidth: 1, borderColor: "#8B96A8", borderRadius: 12, paddingHorizontal: 13, paddingVertical: 9 }, typeChipActive: { backgroundColor: "#1B2A45", borderColor: "#5B9BFF" }, typeChipText: { color: "#97A3B6", fontSize: 12 }, typeChipTextActive: { color: "#5B9BFF", fontWeight: "800" }, input: { borderWidth: 1, borderColor: "#8B96A8", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, color: "#EEF2F8", textAlign: "right", fontSize: 13 }, textArea: { height: 68, textAlignVertical: "top" }, submitButton: { backgroundColor: "#3B82F6", borderRadius: 14, paddingVertical: 14, alignItems: "center", marginTop: 18 }, submitText: { color: "#F5F7FA", fontWeight: "800" },
});
