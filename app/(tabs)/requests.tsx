...
const styles = StyleSheet.create({
  content: { padding: 20, paddingBottom: 40, gap: 17 }, header: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, eyebrow: { color: "#64748B", fontSize: 13, textAlign: "right" }, title: { color: "#0F172A", fontSize: 27, fontWeight: "800", marginTop: 5, textAlign: "right" }, subtitle: { color: "#64748B", fontSize: 12, marginTop: 5, textAlign: "right" }, addButton: { backgroundColor: "#0E7490", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 11 }, addButtonText: { color: "#FFFFFF", fontSize: 12, fontWeight: "800" }, info: { backgroundColor: "#ECFEFF", borderRadius: 18, padding: 17, borderWidth: 1, borderColor: "#A5F3FC" }, infoTitle: { color: "#155E75", fontSize: 13, textAlign: "right" }, infoValue: { color: "#0E7490", fontSize: 30, fontWeight: "800", textAlign: "right", marginTop: 4 }, infoUnit: { color: "#155E75", fontSize: 12, fontWeight: "500" }, infoHint: { color: "#0E7490", fontSize: 11, marginTop: 4, textAlign: "right" }, sectionTitle: { color: "#0F172A", fontSize: 18, fontWeight: "800", textAlign: "right" }, requestCard: { backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E2E8F0", borderRadius: 18, padding: 15 }, requestTop: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center" }, requestType: { color: "#0F172A", fontSize: 15, fontWeight: "800" }, statusBadge: { borderRadius: 9, paddingHorizontal: 9, paddingVertical: 5 }, statusText: { fontSize: 10, fontWeight: "800" }, requestDates: { color: "#475569", fontSize: 12, marginTop: 12, textAlign: "right" }, reason: { color: "#64748B", fontSize: 12, marginTop: 6, lineHeight: 19, textAlign: "right" }, empty: { color: "#64748B", textAlign: "center", padding: 25 }, modalBackdrop: { flex: 1, backgroundColor: "rgba(15,23,42,0.45)", justifyContent: "flex-end" }, modal: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 26, borderTopRightRadius: 26, padding: 20, paddingBottom: 35 }, modalHeader: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }, close: { color: "#64748B", fontSize: 13 }, modalTitle: { color: "#0F172A", fontSize: 20, fontWeight: "800" }, fieldLabel: { color: "#334155", fontSize: 12, fontWeight: "700", marginTop: 10, marginBottom: 6, textAlign: "right" }, typeRow: { flexDirection: "row-reverse", gap: 8 }, typeChip: { borderWidth: 1, borderColor: "#CBD5E1", borderRadius: 12, paddingHorizontal: 13, paddingVertical: 9 }, typeChipActive: { backgroundColor: "#CCFBF1", borderColor: "#0E7490" }, typeChipText: { color: "#64748B", fontSize: 12 }, typeChipTextActive: { color: "#0E7490", fontWeight: "800" }, input: { borderWidth: 1, borderColor: "#CBD5E1", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, color: "#0F172A", textAlign: "right", fontSize: 13 }, textArea: { height: 68, textAlignVertical: "top" }, submitButton: { backgroundColor: "#0E7490", borderRadius: 14, paddingVertical: 14, alignItems: "center", marginTop: 18 }, submitText: { color: "#FFFFFF", fontWeight: "800" },
});
