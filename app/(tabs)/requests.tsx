...
const styles = StyleSheet.create({
  detailModal:{backgroundColor:"#FFF",borderTopLeftRadius:26,borderTopRightRadius:26,padding:20,gap:10},detailHead:{flexDirection:"row-reverse",justifyContent:"space-between",alignItems:"center"},detailTitle:{color:"#0F172A",fontSize:20,fontWeight:"900"},closeText:{color:"#2563EB",fontSize:11},detailType:{color:"#2563EB",fontSize:18,fontWeight:"800",textAlign:"right"},detailDates:{color:"#64748B",fontSize:12,textAlign:"right"},detailStatus:{alignSelf:"flex-end",backgroundColor:"#FEF3C7",borderRadius:99,paddingHorizontal:12,paddingVertical:6},detailStatusText:{color:"#92400E",fontSize:10,fontWeight:"800"},detailLabel:{color:"#64748B",fontSize:10,fontWeight:"700",textAlign:"right",marginTop:10},detailReason:{color:"#0F172A",fontSize:13,lineHeight:20,textAlign:"right"},timeline:{backgroundColor:"#F8FAFC",borderRadius:14,padding:13,marginTop:8},timelineTitle:{color:"#0F172A",fontSize:12,fontWeight:"800",textAlign:"right"},timelineText:{color:"#64748B",fontSize:11,lineHeight:18,textAlign:"right",marginTop:4},
