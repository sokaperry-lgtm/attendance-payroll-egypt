  ...
  return (
    <ScreenContainer>
      <FlatList
        ...
        ListHeaderComponent={<>
          <View style={styles.header}><View><Text style={styles.eyebrow}>حساب الموظف</Text><Text style={styles.title}>سجل الحضور</Text><Text style={styles.subtitle}>{employee.name} · سبتمبر 2026</Text></View><View style={styles.calendarIcon}><IconSymbol name="calendar" size={25} color="#0E7490" /></View></View>
...
const styles = StyleSheet.create({
  ...
  calendarIcon: { backgroundColor: "#CCFBF1", width: 48, height: 48, borderRadius: 16, justifyContent: "center", alignItems: "center" },
  summary: { backgroundColor: "#0F766E", borderRadius: 20, padding: 18, flexDirection: "row-reverse", justifyContent: "space-around", alignItems: "center" },
  summaryValue: { color: "#FFFFFF", fontSize: 25, fontWeight: "800", textAlign: "center" },
  summaryLabel: { color: "#CCFBF1", fontSize: 11, marginTop: 4, textAlign: "center" },
